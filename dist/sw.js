const CACHE='unterwelt-1931-v9',FILES=['./','index.html','style.css','rules.css','online.css','app.js','rules.js','online.js','assets/map/unterwelt-city-map.webp','manifest.webmanifest','icon-192.png','icon-512.png'];
