const CACHE='unterwelt-1931-v4',FILES=['./','index.html','style.css','rules.css','online.css','app.js','rules.js','online.js','manifest.webmanifest','icon-192.png','icon-512.png'];
