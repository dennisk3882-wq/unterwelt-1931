...
assert.doesNotMatch(fs.readFileSync('dist/index.html','utf8'),/map-loader\.js/);
...
assert.equal(mapHash,'d1750af2956ddaba72c1b77a2b73dbcb4c69872c1eabfe95fff0af0ab970bf84','unexpected map artwork');
...
assert.match(fs.readFileSync('dist/style.css','utf8'),/aspect-ratio:941\/1218/);
assert.match(fs.readFileSync('dist/style.css','utf8'),/unterwelt-city-map\.webp/);
assert.match(fs.readFileSync('dist/sw.js','utf8'),/unterwelt-1931-v7/);
